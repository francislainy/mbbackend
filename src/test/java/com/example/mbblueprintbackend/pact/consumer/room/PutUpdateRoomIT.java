package com.example.mbblueprintbackend.pact.consumer.room;
...
class PutUpdateRoomIT {
    ...
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        ...
        return builder
                .given("A request to update a room")
                .uponReceiving("A request to update a room")
                .pathFromProviderState(path + "${roomId}", path + "1bfff94a-b70e-4b39-bd2a-be1c0f898589")
                .body(bodyGiven)
                .method("PUT")
                .headers(headers)
                .willRespondWith()
